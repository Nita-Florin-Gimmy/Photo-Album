function user(e){
    ...
    var get_user_class = parseInt(e.className);

    if (isNaN(get_user_class) === true)
    {

    }else
    {
        var admin_tag_class = get_user_class + 0.0002;
        var mod_tag_class = get_user_class + 0.00002;
        var user_tag_class = get_user_class + 0.000002;
        var sql_role_class = get_user_class + 0.0000000002;
