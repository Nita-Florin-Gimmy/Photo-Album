function mod(e){
    ...
    var get_mod_class = parseInt(e.className);

    if (isNaN(get_mod_class) === true)
    {

    }else
    {
        var admin_tag_class = get_mod_class + 0.0002;
        var mod_tag_class = get_mod_class + 0.00002;
        var user_tag_class = get_mod_class + 0.000002;
        var sql_role_class = get_mod_class + 0.0000000002;
        ...
        if (user_tag.value === "Moderator")
        {

        }else
        {
            admin_tag.style.display = "none"
            mod_tag.style.display = "block"
